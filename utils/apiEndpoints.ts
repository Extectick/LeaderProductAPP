export const API_ENDPOINTS = {
  AUTH: {
    ...
    TELEGRAM_QR_START: '/auth/telegram/qr/start',
    TELEGRAM_QR_STATUS: '/auth/telegram/qr/status',
    TELEGRAM_QR_CANCEL: '/auth/telegram/qr/cancel',
    ...
    MAX_QR_START: '/auth/max/qr/start',
    MAX_QR_STATUS: '/auth/max/qr/status',
    MAX_QR_CANCEL: '/auth/max/qr/cancel',
  },
  PASSWORD_RESET: {
  ...
  CLIENT_ORDERS: {
    ...
    REFERENCE_DETAILS: (kind: string, guid: string) =>
      `/api/client-orders/reference-details/${encodeURIComponent(kind)}/${encodeURIComponent(guid)}`,
    COUNTERPARTIES: '/api/client-orders/counterparties',
    AGREEMENTS: '/api/client-orders/agreements',
    CONTRACTS: '/api/client-orders/contracts',
    WAREHOUSES: '/api/client-orders/warehouses',
    ...
    DERIVE_DRAFT: (guid: string) => `/api/client-orders/${encodeURIComponent(guid)}/derive-draft`,

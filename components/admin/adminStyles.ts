...
export const createAdminStyles = (colors: any) =>
  StyleSheet.create({
    ...
    userColumnWrap: { gap: 12, paddingHorizontal: 12, paddingBottom: 12 },
    userFilters: {
      paddingHorizontal: 12,
      paddingTop: 12,
      paddingBottom: 6,
    ...
    filterChipsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, paddingVertical: 2, paddingRight: 6 },
    filterChip: {
      paddingHorizontal: 10,
      paddingVertical: 6,
      borderRadius: 999,
    ...
    userCardWrap: { paddingHorizontal: 12 },
    ...
    userAvatarText: { fontSize: 16, fontWeight: '800', color: colors.text },
    userPresenceDot: {
      position: 'absolute',
      right: -2,
      bottom: -2,
    ...
    userIdText: { fontSize: 11, fontWeight: '800', color: colors.secondaryText },
    userMeta: { fontSize: 12, color: colors.secondaryText },
    userMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
    userMetaStrong: { fontSize: 12, fontWeight: '800', color: colors.text },
    ...
    rolePillText: { fontSize: 11, fontWeight: '800', color: colors.secondaryText },
    departmentPill: {
      paddingHorizontal: 8,
      paddingVertical: 4,
      borderRadius: 999,
    ...
    departmentPillText: { fontSize: 11, fontWeight: '800', color: colors.text },
    userPresenceRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    userPresenceDotSmall: { width: 8, height: 8, borderRadius: 4 },
    userPresenceText: { fontSize: 12, color: colors.secondaryText },

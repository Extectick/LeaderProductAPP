...
import { Dialog, Portal, Text, TextInput, TouchableRipple } from 'react-native-paper';
...
function TouchableOpacity({ children, ...props }: any) {
  return (
    <TouchableRipple {...props}>
      <View>{children}</View>
    </TouchableRipple>
...
function PaperBackdrop({ children, onPress }: { children: React.ReactNode; onPress?: () => void }) {
  return (
    <TouchableRipple onPress={onPress} style={StyleSheet.absoluteFill}>
...
export default function RolesTab({ active, styles, colors }: RolesTabProps) {
  ...
  return (
    <>
      ...
      <PaperModal visible={active && !!rolePermModal} transparent animationType="fade" onRequestClose={() => setRolePermModal(null)}>
        <View style={styles.modalOverlay}>
          <PaperBackdrop onPress={() => setRolePermModal(null)}>
            <View style={StyleSheet.absoluteFill} />
          </PaperBackdrop>
      ...
      <PaperModal visible={active && groupsModalVisible} transparent animationType="fade" onRequestClose={() => setGroupsModalVisible(false)}>
        <View style={styles.modalOverlay}>
          <PaperBackdrop onPress={() => setGroupsModalVisible(false)}>
            <View style={StyleSheet.absoluteFill} />
          </PaperBackdrop>
      ...
      <PaperModal visible={active && !!editRoleModal} transparent animationType="fade" onRequestClose={() => setEditRoleModal(null)}>
        <View style={styles.modalOverlay}>
          <PaperBackdrop onPress={() => setEditRoleModal(null)}>
            <View style={StyleSheet.absoluteFill} />
          </PaperBackdrop>
